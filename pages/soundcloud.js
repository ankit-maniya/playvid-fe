...
const Soundcloud = () => {
  ...
  const handleBtnDownload = async (search) => {
    ...
    try {
      setLoading(true);
      const iRes = await VideoService.get_soundcloud({ url: search });
  ...
  return (
    <>
      <Head>
        <title>{videoData?.title || "Soundcloud Music Downloader"}</title>
        ...
        <div className=" lg:h-screen bg-slate-900 backdrop-blur-sm">
          ...
          <div className="flex h-full lg:h-vh-80 justify-center align-middle">
            <div className="my-24 lg:m-auto flex-auto">
              <HeroInfo fulltitle="Download Soundcloud Music" />
